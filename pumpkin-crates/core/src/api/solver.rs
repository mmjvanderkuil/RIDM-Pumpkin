...
use crate::branching::branchers::variable_vsid::VariableVsidBrancher;
...
pub type DefaultBrancher =
    VariableVsidBrancher<IndependentVariableValueBrancher<DomainId, InputOrder<DomainId>, InDomainMin>>;
